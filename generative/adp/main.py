...
def parse_args_and_config():
    ...
    parser.add_argument('--ni', default=True, help='Output path, including images and logs')

    parser.add_argument('--log', default='imgs', help='Output path, including images and logs')
    parser.add_argument('--config', type=str, default='sigma025_bpda+eot30.yml',  help='Path for saving running related data.')
    ...
    parser.add_argument('--adv_threat_model', type=str, default='')
    parser.add_argument('--batch_size', type=str, default='')
    parser.add_argument('--first_step', type=str, default='')
    ...
    parser.add_argument("--adv_attack_type", type=str, default='clean-wrn-28-10.pth', help="")
    parser.add_argument("--adv_epsilon", type=str, default='clean-wrn-28-10.pth', help="")
    ...
    # parse config file
    with open(os.path.join('generative/adp/configs', args.config), 'r') as f:
        config = yaml.load(f, Loader=yaml.Loader)
        new_config = dict2namespace(config)

    # if os.path.exists(args.log):
    #     shutil.rmtree(args.log)
    if os.path.exists(args.log) == False:
